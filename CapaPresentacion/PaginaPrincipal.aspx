  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="Modulo1.aspx">MANTENIMIENTO</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="ModuloProcesos.aspx">PROCESOS</a>
      </li>
         <li class="nav-item active">
        <a class="nav-link" href="ModuloReportes.aspx">REPORTES</a>
      </li>
    </ul>
